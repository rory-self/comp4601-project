...
> The 293 MHz here is the *standalone coder* at the time these notes were written.
> Re-synthesising the committed config today gives 342.47 MHz standalone and
> **273.97 MHz for the board top**, which is the figure to quote for the built
> design. See [`REPRODUCIBILITY.md`](REPRODUCIBILITY.md) §2. The point of this section — that breaking the
> recurrence raises the clock as well as the II — is unchanged.
