...
entity arith_encode_control_s_axi is
generic (
...
end entity arith_encode_control_s_axi;
...
architecture behave of arith_encode_control_s_axi is
...
attribute DowngradeIPIdentifiedWarnings of behave : architecture is "yes";
    ...
    constant ADDR_N_DATA_0     : INTEGER := 16#24#;
    constant ADDR_N_CTRL       : INTEGER := 16#28#;
    constant ADDR_OUT_R_DATA_0 : INTEGER := 16#2c#;
    constant ADDR_OUT_R_DATA_1 : INTEGER := 16#30#;
    constant ADDR_OUT_R_CTRL   : INTEGER := 16#34#;
