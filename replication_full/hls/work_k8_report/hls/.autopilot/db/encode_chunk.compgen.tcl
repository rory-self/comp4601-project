...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler arith_encode_encode_chunk_tree_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename in_r \
    op interface \
    ports { in_r_address0 { O 10 vector } in_r_ce0 { O 1 bit } in_r_q0 { I 8 vector } } \
} "
} else {
