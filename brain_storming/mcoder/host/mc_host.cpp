...
int main(int argc, char **argv) {
    if (has_flag(argc, argv, "-h")) {
        std::cout <<
          ...
          "      for comparison with cosim (default 167 -- V7 closes at 6.0ns)\n";
        return 0;
    }
    ...
    double mhz = std::stod(arg_of(argc, argv, "-c", "167"));
    ...
    std::cout << "                   (cosim predicted 6.67 at K=8; a large gap\n"
                 "                    means host/AXI overhead, not the coder)\n";
